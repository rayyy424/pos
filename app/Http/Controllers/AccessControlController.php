...
class AccessControlController extends Controller {
    ...
    public function index()
    {
        ...
        $users = DB::table('users')->select('users.Id','files.Web_Path','users.StaffId as Staff_ID','users.Name','users.Nick_Name','users.User_Type','users.Company_Email','users.Personal_Email','users.Contact_No_1','users.Contact_No_2','users.Permanent_Address','users.Current_Address','users.Country_Base','users.Home_Base','users.Nationality','users.DOB','users.NRIC','users.Passport_No','users.Gender','users.Marital_Status','superior.Name as Superior','users.Department','users.Position','users.Joining_Date','users.Resignation_Date','users.Emergency_Contact_Person','users.Emergency_Contact_No','users.Emergency_Contact_Relationship','users.Emergency_Contact_Address')
        ...
        DB::raw("if(`accesscontroltemplates`.Project_Access, 'Yes', 'No') as Project_Access"),
        ...
        DB::raw("if(`accesscontroltemplates`.Create_Project, 'Yes', 'No') as Create_Project"),
        DB::raw("if(`accesscontroltemplates`.Create_Project_Code, 'Yes', 'No') as Create_Project_Code"),
        DB::raw("if(`accesscontroltemplates`.Project_Manager, 'Yes', 'No') as Project_Manager"),
        DB::raw("if(`accesscontroltemplates`.View_Project_List, 'Yes', 'No') as View_Project_List"),
        ...
        DB::raw("if(`accesscontroltemplates`.Project_Requirement, 'Yes', 'No') as Project_Requirement"),
        ...
        DB::raw("if(`accesscontroltemplates`.Delete_File, 'Yes', 'No') as Delete_File"),
    		DB::raw("if(`accesscontroltemplates`.Edit_Project_Code, 'Yes', 'No') as Edit_Project_Code"),
        ...
        DB::raw("if(`accesscontroltemplates`.View_Department_Attendance_Summary, 'Yes', 'No') as View_Department_Attendance_Summary"),
        ...
        DB::raw("if(`accesscontroltemplates`.Genset, 'Yes', 'No') as Genset"),
        DB::raw("if(`accesscontroltemplates`.Genset_Summary, 'Yes', 'No') as Genset_Summary"),
    ...
    public function update(Request $request)
    {
            ...
            ->update(array(
                        ...
                        'Create_Project_Code' =>  $input["Create_Project_Code"],
                        'Project_Manager' =>  $input["Project_Manager"],
                        'View_Project_List' =>  $input["View_Project_List"],
                        ...
                        'Project_Requirement' =>  $input["Project_Requirement"],
                        ...
                        'Delete_File' =>  $input["Delete_File"],
            						'Edit_Project_Code' =>  $input["Edit_Project_Code"],
                        ...
                        'View_Department_Attendance_Summary' =>  $input["View_Department_Attendance_Summary"],
                        ...
                        'Genset'=>$input['Genset'],
                        'Genset_Summary' => $input['Genset_Summary'],
