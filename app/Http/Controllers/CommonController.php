...
class CommonController extends Controller {
    ...
    ->leftJoin('accesscontroltemplates', 'accesscontroltemplates.Id', '=', 'users.AccessControlTemplateId')
		...
		->select('users.Id as UserId','users.AccessControlTemplateId','users.StaffId as Staff_ID','users.Name','users.Nick_Name','users.Company_Email','users.Personal_Email','users.Contact_No_1','users.Contact_No_2','users.Permanent_Address','users.Current_Address','users.Country_Base','users.Home_Base','users.Password','users.User_Type','users.Nationality','users.DOB','users.NRIC','users.Passport_No','users.Gender','users.Marital_Status','users.SuperiorId','users.Company','users.Entitled_for_OT','users.Working_Days','users.Position','users.Grade','users.Joining_Date','users.Resignation_Date','users.Emergency_Contact_Person','users.Emergency_Contact_No','users.Emergency_Contact_Relationship','users.Emergency_Contact_Address','users.Note','users.Active','users.Admin','users.Approved',
		...
		'Detail_Approved_On','Status','Comment',
