...
@section('content')
    ...
    <section class="content">
      ...
      <div class="row>">
        ...
        <div class="col-md-2">
          <select class="form-control" id="companyselected">
            <option></option>
            @foreach($company as $com)

              <option <?php if($com->Option == $companyselected) echo ' selected="selected" '; ?>>{{$com->Option}}</option>
        ...
        <div class="col-md-2">
          <select class="form-control" id="vehiclenumber">
            ...
            @foreach($vehiclenumbers as $num)

              <option <?php if($num->Vehicle_No == $carnumber) echo ' selected="selected" '; ?>>{{$num->Vehicle_No}}</option>
