                                                              ...
                                                              <table cellpadding="5px" cellspacing="0" border="1" width="100%">
                                                                <thead>
                                                                  <tr>
                                                                    ...
                                                                    <th style="width:20%;text-align:left;">Additional Description</th>
                                                                    <th style="width:20%;text-align:left;">Item Unit</th>
                                                                    <th style="width:20%;text-align:left;">Requested Quantity</th>
                                                                  </tr>
                                                                  @foreach($items as $dil => $dils)
                                                                  <tr>
