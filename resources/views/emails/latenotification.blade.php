                                                      ...
                                                      @if (sizeof($late)>0)
                                                        ...
                                                        <tbody>
                                                          ...
                                                          @foreach($late as $key=>$value)
                                                            ...
                                                            @elseif($value->Leave_Type=="Annual Leave" && $value->Leave_Status=="Final Approved")
                                                              {{--  on leave display nothing--}}

                                                            @elseif($value->Leave_Type!=null && $value->Leave_Type!="Annual Leave")
                                                              {{--  other leave display nothing--}}
