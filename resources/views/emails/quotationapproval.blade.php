                                                ...
                                                <table cellpadding="3px" cellspacing="5px" border="0" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$d->Status}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Requestor Reason</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$d->Requestor_Reason != "" ? $d->Requestor_Reason:"-"}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Reason</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$d->Reason != "" ? $d->Reason:"-"}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
