                                                ...
                                                <table cellpadding="3px" cellspacing="5px" border="0" width="100%">
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <th style="text-align:center;white-space: nowrap;">Submitter</th>
                                                      ...
                                                      @foreach ($claims as $claim)
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="text-align:center;white-space: nowrap;">{{$claim->Submitter}}</td>

                                                            <td style="text-align:center;white-space: nowrap;">{{$claim->Expenses_Type}}</td>

                                                            <td style="text-align:center;white-space: nowrap;">{{$claim->Remarks}}</td>

                                                            <td style="text-align:center;white-space: nowrap;">{{$claim->Approver}}</td>

                                                            <td style="text-align:center;white-space: nowrap;">{{$claim->Status}}</td>
                                                        </tr>
