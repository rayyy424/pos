                                            ...
                                            <td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:30px 30px;border-radius: 10px;font-size:14px;line-height:22px;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Vehicle</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Vehicle_No}}</td>
                                                        </tr>
                                                        
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Site</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Location}}</td>
                                                        </tr>
                                                        ...
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Application DateTime</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->created_at}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
