                                            ...
                                            <td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:30px 30px;border-radius: 10px;font-size:14px;line-height:22px;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tbody>
                                                        ...
                                                        @if($deliverydetail->DO_No != null)
                                                             <tr valign="top">
                                                                <td style="width:45%;text-align:right;;">DO Number</td>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Requestor}}</td>
                                                        </tr>
                                                        ...
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Delivery Time</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Delivery_Time}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Pick Up Time</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Pickup_Time}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Location</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Status}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Activity</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$deliverydetail->Details}}</td>
                                                        </tr>
