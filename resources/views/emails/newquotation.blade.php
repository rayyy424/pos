                                                ...
                                                <table cellpadding="3px" cellspacing="5px" border="0" width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="width:45%;text-align:left;">{{$detail->MR_No}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Project Name</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$detail->Project_Name}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Site</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$detail->site}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Unique Id</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$detail->uniqueId}}</td>
                                                        </tr>
                                                        <tr valign="top">
                                                            <td style="width:45%;text-align:right;;">Total(RM)</td>
                                                            <td style="width:10%;text-align:center;">:</td>
                                                            <td style="width:45%;text-align:left;">{{$d->Amount}}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
