                          ...
                          <td>
                              ...
                              <br>
                                <p style="margin:0 0 36px; text-align:center; font-size:16px; line-height:22px; text-transform:uppercase; color:#626658;">
                                    Insuficient stock for {{$deliverydetail->DO_No}}
                                </p>
                                                    ...
                                                    <table cellpadding="3px" cellspacing="5px" border="0" width="100%">
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <th style="text-align:center;white-space: nowrap;">Item Description</th>
                                                            <th style="text-align:center;white-space: nowrap;">Item Remarks</th>
                                                            <th style="text-align:center;white-space: nowrap;">Unit</th>
                                                            <th style="text-align:center;white-space: nowrap;">Quantity Request</th>
                                                          ...
                                                          @foreach ($items as $item)
                                                              ...
                                                              <tr valign="top">
                                                                  ...
                                                                  <td style="text-align:center;white-space: nowrap;">{{$item->Categories}}</td>
                                                                  <td style="text-align:center;white-space: nowrap;">{{$item->Item_Code}}</td>
                                                                  <td style="text-align:center;white-space: nowrap;">{{$item->Description}}</td>
                                                                  <td style="text-align:center;white-space: nowrap;">{{$item->Remark}}</td>
                                                                  <td style="text-align:center;white-space: nowrap;">{{$item->Unit}}</td>
                                                                  <td style="text-align:center;white-space: nowrap;">{{$item->Qty_request}}</td>
                                                              </tr>
                                                              <?php $i++; ?>
