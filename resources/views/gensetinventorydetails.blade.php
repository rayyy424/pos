    ...
    $(document).ready(function() {
		...
		balancetable =$('#balancetable').dataTable( {
			...
			columns: [
				...
				// { data:"gensetinventory_history.gensetInventoryId", title:'gensetId'},
				{ data:"gensetinventory_history.Id", title:'Id'},
				{ data:"gensetinventory_history.branch", title:'Branch'},
				{ data:"gensetinventory_history.total", title:'Balance',
					"render": function ( data, type, full, meta ) {
					return '<a href="/genset/inventoryhistory/'+full.gensetinventory_history.branch+'/{{$id}}" target="_blank"><button class="btn btn-default btn-xs" title="History" style="width:unset">'+data+'</button></a>';
					}
				}
			],
			autoFill: {
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
            ...
            <li>GENSET Inventory Management</li>
            <li class="active">GENSET Inventory Details</li>
		</ol>
	</section>
