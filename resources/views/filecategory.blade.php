          ...
          <div class="row">
                  ...
                  @foreach ($category as $cat)
                    ...
                    <div class="col-md-2">
                        ...
                        <img src="{{ url('/img/folder.png') }}" alt="Photo" width="200px" height="100%"/><br>
                        <center><a href="{{ URL::to("/")}}/filerenderer/{{$cat->Document_Type}}/{{$trackerid}}" target="_blank">{{ $cat->Document_Type}}</a></center>
