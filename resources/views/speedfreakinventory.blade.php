            ...
            iDisplayLength:10,
             fnInitComplete: function(oSettings, json) {
                        ...
                        api.rows().every( function (){
                       	var d = this.data();
                    	console.log(d);
                        total = d.inventorypricehistory.price * d.speedfreakinventory.qty_balance;
                        grand = grand + total;
                    	});
                        console.log(grand);
			...
			columns: [
				...
				{ title:'Total Amount(RM)',
					render: function ( data, type, full, meta ) {
						...
						var qty = full.speedfreakinventory.qty_balance;
						var total = price * qty;
	            ...
	            <div class="col-md-12">
	            	...
	            	<table id="inventorytable" class="inventorytable" cellspacing="0" width="100%" padding="30px" style="font-size: 13px; white-space: pre-line;">
		              	<thead>
                            ...
                            <tbody>
                                <?php $i = 0; ?>
                                @foreach($speedfreakinventory as $delivery)
 ...
 function OpenModal(row)
  {
 	  ...
 	  $('#qty_balance').val(oTable.api().row(row).data().speedfreakinventory.qty_balance)
	...
	function refresh()
{
      ...
      // if(b == "")
      // {
      // 	window.location.href ="{{ url('/speedfreak/inventory') }}/"+arr[0]+"/"+arr[1];
      // }
      // else
      // {
      // 	window.location.href ="{{ url('/speedfreak/inventory') }}/"+arr[0]+"/"+arr[1] + b;
      // }

      window.location.href ="{{ url('/speedfreak/inventory') }}/"+ b;
}
