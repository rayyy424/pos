...
<script type="text/javascript" language="javascript" class="init">
        ...
        $(document).ready(function() {
          ...
          $('#alltab').html("All Staff Loan" + "[" + alltable.api().rows().count() +"]")
          $('#pendingtab').html("Pending Staff Loan" + "[" + pendingtable.api().rows().count() +"]")
          $('#approvedtab').html("Approved Staff Loan" + "[" + approvedtable.api().rows().count() +"]")
          $('#rejectedtab').html("Rejected Staff Loan" + "[" + rejectedtable.api().rows().count() +"]")
          $('#finaltab').html("All Final Approved Staff Loan" + "[" + allfinaltable.api().rows().count() +"]")
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li class="active">Staff Loan Management</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#pending" data-toggle="tab" id="pendingtab">Pending Staff Loan</a></li>
              <li><a href="#approved" data-toggle="tab" id="approvedtab">Approved Staff Loan</a></li>
              <!-- <li><a href="#rejected" data-toggle="tab" id="rejectedtab">Rejected Staff Loan</a></li> -->
              <li><a href="#all" data-toggle="tab" id="alltab">All Staff Loan</a></li>
              <li><a href="#final" data-toggle="tab" id="finaltab">All Final Approved Staff Loan</a></li>
            </ul>
              ...
              <div class="tab-pane" id="all">
                  ...
                  <table id="alltable" class="alltable" cellspacing="0" width="100%" padding="30px" style="font-size: 13px;">
                      ...
                      <tbody>
                        ...
                        <?php $i = 0; ?>
                        @foreach($all as $staffloan)

                          <tr id="row_{{ $i }}">
                            <td></td>
                              @foreach($staffloan as $key=>$value)
                                <td>
                                  {{ $value }}
                                </td>
                              @endforeach
