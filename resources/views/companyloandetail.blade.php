        ...
        var editor;
                 ...
                 $(document).ready(function() {
                   ...
                   editor = new $.fn.dataTable.Editor( {
                           ajax: {
                              "url": "{{ asset('/Include/companyloaninstallments.php') }}"
                            },
                           table: "#loan",
                           idSrc: "companyloaninstallments.Id",
                           formOptions: {
                                bubble: {
                                    submit: 'allIfChanged'
                                }
                           ...
                           fields: [
                                   {
                                              label: "CompanyLoanId:",
                                              name: "companyloaninstallments.CompanyLoanId",
                                              type: "hidden",
                                              def: "{{ $companyloanid }}"

                                   },{
                                             label: "Amount:",
                                             name: "companyloaninstallments.Amount",
                                             attr: {
                                                type: "number"
                                              }
                                  },{
                                            label: "Status:",
                                            name: "companyloaninstallments.Paid",
                                            type:  "select",
                                            options: [
                                             ...
                                             label: "Payment_Date:",
                                             name: "companyloaninstallments.Payment_Date",
                                             type:   'datetime',
                                             format: 'DD-MMM-YYYY',
                                             attr: {
                                              autocomplete: "off"
                                             ...
                                             label: "created_at:",
                                             name: "companyloaninstallments.created_at",
                                             type: "hidden",
                   ...
                   $('#loan').on( 'click', 'tbody td:not(:first-child)', function (e) {
                       ...
                       loantable = $('#loan').dataTable( {
                         ajax: {
                          ...
                          rowId:"companyloaninstallments.Id",
                           dom: "Blrtip",
                           bAutoWidth: true,
                          //  sScrollY: "100%",
                          //  sScrollX: "100%",
                            ...
                            var totalloan=0.0;
                             ...
                             var totalbalance=0.0;
                              ...
                              loantable.api().rows().every( function () {
                                 var d = this.data();
                                 totalloan={{$companyloan[0]->Total_Approved ? $companyloan[0]->Total_Approved : 0}};
                                  if (d.companyloaninstallments.Paid == 1) {

                                    totalpayback=totalpayback+parseFloat(d.companyloaninstallments.Amount);
                                  }
                           ...
                           columns: [
                             ...
                             {data:'companyloaninstallments.Id', title:"Id"},
                             {data:'companyloaninstallments.Payment_Date', title:"Repayment_Date"},
                             {data:'companyloaninstallments.Amount', title:"Amount"},
                             {data:'companyloaninstallments.Paid', title:"Status", render: function (val, type, row) {
                                return val == 0 ? "Pending" : "Paid";
                             }},
                             {data:'companyloaninstallments.created_at', title:'Created_At'},
                             {data:'companyloaninstallments.updated_at', title:'Updated_At'}
                           ...
                           buttons: [
                                   ...
                                   //       editor
                                   //          .create( false )
                                   //          .set( 'companyloaninstallments.CompanyLoanId', {{ $companyloanid }} )
                                   //          .set( 'companyloaninstallments.created_at', "{{ date("Y-m-d H:i:s") }}" )
                                   //          .submit();
                                   //   },
                                   // },
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      CompanyLoan Detail
      <small>CompanyLoan Management</small>
      </h1>

      <ol class="breadcrumb">
      <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="#">Resource Management</a></li>
      <li><a href="#">CompanyLoan Management</a></li>
      <li class="active">CompanyLoan Detail</li>
      </ol>
    </section>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  Are you sure you wish to submit companyloan for next action?
              </div>
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="submit({{$companyloanid}})">Yes</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="ExportPDF" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you wish to export this companyloan request?
            </div>
            <div class="modal-footer">
              <a class="btn btn-primary btn-lg" href="{{ url('/exportstaffloan') }}/{{$companyloanid}}" target="_blank">Export</a>
        ...
        {{-- <div class="modal fade" id="Submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                  Are you sure you wish to submit the companyloan for next action?
              </div>
              <div class="modal-footer">
                <center><img src="{{ URL::to('/') ."/img/ajax-loader.gif" }}" width="50px" height="50px" alt="Loading" name='ajaxloader' id="ajaxloader"></center>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
          ...
          <div class="box box-info">
            <div class="box-body">
              ...
              <form enctype="multipart/form-data" id="upload_form" role="form" method="POST" action="" >
                ...
                <h3>COMPANY LOAN FORM</h3>
                @foreach ($companyloan as $companyloans)
                <div class="box-body">

                    <h4>Company Details</h4>

                    <input type="hidden" name="CompanyId" value="{{ $companyloans->Id }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-9">
                            : {{$companyloans->Bank_Name == "" ? "-" : $companyloans->Bank_Name}}
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-9">
                            : {{$companyloans->Bank_Account_No == "" ? "-" : $companyloans->Bank_Account_No}}
                          </div>
                        </div> 
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-9">
                            : {{$companyloans->Contact_No=="" ? "-" : $companyloans->Contact_No}}
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-9">
                            : {{$companyloans->Company_Account == "" ? "-" : $companyloans->Company_Account}}
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="col-md-5">
                            ...
                            <select class="form-control select2" id="BankIn" name="BankIn" style="width: 70%;">
                              <option></option>
                              <option value="Paid" <?php if($companyloan[0]->PaidStatus == "Paid") echo "selected" ?> >Paid</option>
                              <option value="Unpaid" <?php if($companyloan[0]->PaidStatus == "Unpaid") echo "selected" ?> >Unpaid</option>
                            </select>
                         </div>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <h4>Loan Required</h4>
                        <table class="table table-bordered">
                          ...
                          <?php $i = 0; ?>
                           @foreach($companyloandetails as $companyloandetail)

                               <tr id="row_{{ $i }}">
                                   <td style="text-align:right">{{$companyloandetail->Type}}</td>
                                   <td>{{$companyloandetail->Total}}</td>
                               </tr>
                           ...
                           <tr>
                             <td style="text-align:right">Total CompanyLoan Requested : </td>
                             <td><input type="text" class="form-control" id="" name="" value="{{$companyloans->Total_Requested}}" disabled=""></td>
                           </tr>


                           <tr>
                             <td style="text-align:right">Total CompanyLoan Approved : </td>
                               <input type="hidden" class="form-control" id="CompanyLoanId" name="CompanyLoanId" value="{{$companyloanid}}">
                             <td><input type="number" class="form-control" id="Total_Approved" name="Total_Approved" value="{{$companyloans->Total_Approved}}"></td>
                           </tr>
                          ...
                          <!-- Month 1 -->
                           <tr>
                             <td style="text-align:right">Month 1 : </td>
                               <input type="hidden" class="form-control" id="CompanyLoanId" name="CompanyLoanId" value="{{$companyloanid}}">
                             <td><input type="number" class="form-control" id="Repayment_1" name="Repayment_1" value="{{$companyloans->Repayment_1}}"></td>
                           </tr>
                           ...
                           <!-- Month 2 -->
                            <tr>
                              ...
                              <td><input type="number" class="form-control" id="Repayment_2" name="Repayment_2" value="{{$companyloans->Repayment_2}}"></td>
                            </tr>
                            ...
                            <!-- Month 3 -->
                             <tr>
                               ...
                               <td><input type="number" class="form-control" id="Repayment_3" name="Repayment_3" value="{{$companyloans->Repayment_3}}"></td>
                             </tr>
                             ...
                             <!-- Month 4 -->
                              <tr>
                                ...
                                <td><input type="number" class="form-control" id="Repayment_4" name="Repayment_4" value="{{$companyloans->Repayment_4}}"></td>
                              </tr>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                          <form enctype="multipart/form-data" id="upload_form2" role="form" method="POST" action="" >
                            <input type="hidden" class="form-control" id="CompanyLoanId" name="CompanyLoanId" value="{{$companyloan[0]->Id}}">
              ...
              <div class="row">
                <div class="col-md-12">
                    <div class="col-lg-4">
                        ...
                        <select class="form-control select2" id="NewApprover" name="NewApprover" style="width: 70%;" <?php if( strpos($companyloan[0]->Status,"Final Approved") !== false) echo "disabled";  ?>>
                        <option></option>
                        @foreach ($approver as $user)
                            <option value="{{$user->Id}}" <?php if($user->Id == $companyloan[0]->approverId && (strpos($companyloan[0]->Status,'Approved') !== false) ) echo "selected"; ?> >{{$user->Name}}</option>
                        @endforeach
                        </select>
                  </div>
                @if( $companyloan[0]->Status !== "Cancelled" && $companyloan[0]->Status !== "Rejected" && $companyloan[0]->Status !== "Final Approved" && $companyloan[0]->Status !== "Recall")
                <button type="submit" class="btn btn-success btn-xs" onclick="approve()">Approve</button>
                <button type="submit" class="btn btn-danger btn-xs" onclick="reject('{{$companyloanid}}')">Reject</button>
          ...
          <div class="col-md-12">
            <div class="box box-info">
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                    <h3>COMPANY LOAN INSTALLMENT RECORD</h3>
                    <ul class="list-group list-group-unbordered">
                      <li class="list-group-item">
                        <b>Name</b> : <p class="pull-right"><i>{{ $companyloan[0]->Company_Name }}</i>
                      </li>

                      <li class="list-group-item">
                        <b>Total Loan</b> : <p class="pull-right"><i>RM{{ $companyloan[0]->Total_Approved ? $companyloan[0]->Total_Approved : '0.00' }}</i>
                      </li>
...
$(function () {
  ...
  var repay = {{$companyloans->Repayment}}
  ...
  for (var i = 1; i <= {{$companyloans->Repayment}}; i++) {
...
function submit(companyloanid) {
    ...
    $.ajax({
                ...
                method: "POST",
                  data: {CompanyLoanId:companyloanid},
...
function approve() {
    ...
    var companyloanid={{$companyloanid}};
    ...
    $.ajax({
                ...
                success: function(response){
                  ...
                  if (response==1)
                  {
                      ...
                      var message="CompanyLoan application approved!";
                      $("#update-alert ul").html(message);
                      $("#update-alert").modal('show');
                      //
                      setTimeout(function() {
    ...
    $.ajax({
                ...
                success: function(response){
                  ...
                  if (response==1)
                  {
                      ...
                      var message="CompanyLoan application rejected!";
                      $("#update-alert ul").html(message);
                      $("#update-alert").modal('show');
...
function redirect() {
    ...
    $.ajax({
                url: "{{ url('/companyloan/redirect') }}",
                method: "POST",
                data: {CompanyLoanId:companyloanid,Approver:newapprover},
...
function deletereceipt(id) {
  ...
  $.ajax({
              url: "{{ url('/companyloan/deletereceipt') }}",
              method: "POST",
              data: {Id:id},
              success: function(response){
                if (response==0)
...
function uploadreceipt() {
    ...
    $.ajax({
                url: "{{ url('/companyloan/uploadreceipt') }}",
                method: "POST",
                contentType: false,
                processData: false,
...
$(document).ready(function() {
    $(document).on('change', '#BankIn', function(e) {
        var companyloanid = "{{$companyloanid}}";
        changepaymentstatus(companyloanid);
    });
});

function changepaymentstatus(companyloanid)
{
  console.log('2')
  $.ajaxSetup({
       headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') }
    ...
    $.ajax({
                url: "{{ url('/companyloan/updateBankIn') }}",
                method: "POST",
                data:{
                  CompanyLoanId : companyloanid,
                  Status : BankIn,
