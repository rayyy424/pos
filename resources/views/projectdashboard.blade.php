...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li class="active">{{$project->Project_Name}} Dashboard</li>
      </ol>
    </section>
                  ...
                  <div class="form-group">
                   ...
                   <select class="form-control select2" id="Project" name="Project" style="width: 100%;">
                     ...
                     @foreach($projects as $p)
                         ...
                         <option <?php if($p->Id==$projectid) echo ' selected="selected" '; ?>>{{$p->Project_Name}}</option>
                     @endforeach
...
function refresh()
{
  ...
  window.location.href ="{{ url("/customizereport") }}/{{$projectid}}/"+region;
