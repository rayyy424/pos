      ...
      <div class="row>">
        ...
        <div class="col-md-2">
          <div class="input-group">
            <input type="number" class="form-control" id="year" disabled="true" value="{{$year}}">
          </div>
        </div>
        <div class="col-md-4">
          <select id="user" class="form-control select2" disabled="true">
            @foreach($user as $u)
            <option disabled="true" value="{{$u->Id}}" <?php if($userid == $u->Id) echo "selected"; ?> >{{$u->Name}}</option>
            @endforeach
          </select>    
        </div>
        </div>
                            ...
                            <div class="col-md-8">
                              <div class="box box-primary">
                                <div class="box-header with-border">
                                  <h4 class="box-title">KPI Graph</h4>
                                </div>
                                <div class="box-body">
                                  <div class="chart">
                              ...
                              <div class="box box-primary">
                                <div class="box-header with-border">
                                  <table class="table table-bordered">
                                    <tr class="header">
                                      <td>Month</td>
                                      <td>Total Day(s) Attend</td>
                                    </tr>
                                    <?php $i = 0; ?>
                                    @foreach($attend as $first)
