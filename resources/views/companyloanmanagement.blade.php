        ...
        $(document).ready(function() {
                  ...
                  columns:[
                    {
                         ...
                         "render": function ( data, type, full, meta ) {
                             ...
                             return '<a href="{{url('/companyloans/')}}/'+full.companyloans.Id+'" >View</a>';
                         }
                    },

                    {data:"companyloans.Id", title:"Id"},
                    {data:"companyloanstatuses.Status", title:"Status",
                      "render": function ( data, type, full, meta ) {

                           if(full.companyloanstatuses.Status.includes("Approved"))
                           {
                             return "<span class='green'>"+full.companyloanstatuses.Status+"</span>";
                           }
                           else if(full.companyloanstatuses.Status.includes("Rejected"))
                           {
                             return "<span class='red'>"+full.companyloanstatuses.Status+"</span>";
                           }
                           else {
                             return "<span class='yellow'>"+full.companyloanstatuses.Status+"</span>";
                           }

                        }
                    },
                    {data:"users.Name", title:"Name"},
                    {data:"companyloans.Date", title:"Date"},
                    {data:"companyloans.Total_Requested", title:"Total_Requested"},
                    {data:"companyloans.Total_Approved", title:"Total_Approved"},
          ...
          allfinaltable=$('#allfinaltable').dataTable( {
                  ...
                  columns:[
                    ...
                    {data:"companyloans.Total_Approved", title:"Total_Approved"},
                    {data:"Approver", title:"Approver"},
                    {data:"allfinal.PaidStatus", title:"Bank In"},
          ...
          $('#alltab').html("All Company Loan" + "[" + alltable.api().rows().count() +"]")
          $('#pendingtab').html("Pending Company Loan" + "[" + pendingtable.api().rows().count() +"]")
          $('#approvedtab').html("Approved Company Loan" + "[" + approvedtable.api().rows().count() +"]")
          $('#rejectedtab').html("Rejected Company Loan" + "[" + rejectedtable.api().rows().count() +"]")
          $('#finaltab').html("All Final Approved Company Loan" + "[" + allfinaltable.api().rows().count() +"]")
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      SpeedFreak Loan Management
      <small>SpeedFreak Management</small>
      </h1>

      <ol class="breadcrumb">
      <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i>Home</a></li>
      <li><a href="#">SpeedFreak Management</a></li>
      <li class="active">SpeedFreak Loan Management</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#pending" data-toggle="tab" id="pendingtab">Pending Company Loan</a></li>
              <li><a href="#approved" data-toggle="tab" id="approvedtab">Approved Company Loan</a></li>
              <!-- <li><a href="#rejected" data-toggle="tab" id="rejectedtab">Rejected Company Loan</a></li> -->
              <li><a href="#all" data-toggle="tab" id="alltab">All Company Loan</a></li>
              <li><a href="#final" data-toggle="tab" id="finaltab">All Final Approved Company Loan</a></li>
            </ul>
              ...
              <div class="tab-pane" id="all">
                  ...
                  <table id="alltable" class="alltable" cellspacing="0" width="100%" padding="30px" style="font-size: 13px;">
                      ...
                      <tbody>
                        ...
                        <?php $i = 0; ?>
                        @foreach($all as $companyloan)

                          <tr id="row_{{ $i }}">
                            <td></td>
                              @foreach($companyloan as $key=>$value)
                                <td>
                                  {{ $value }}
                                </td>
                              @endforeach
...
function refresh()
{
  ...
  window.location.href ="{{ url("/companyloanmanagement") }}/"+arr[0]+"/"+arr[1];
