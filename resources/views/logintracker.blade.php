...
@section('datatable-js')
      ...
      $(document).ready(function() {
        ...
        var login = $('#logintracktable').DataTable( {
            ...
            column:[
              ...
              {data: "logintrackings.Event", title: "Event"},
              {data: "logintrackings.Date_Time", title: "Date_Time"}
            ],
            select: {
                    style:    'os',
                    selector: 'tr'
      ...
      login.on( 'order.dt search.dt', function () {
        login.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
            cell.innerHTML = i+1;
        } );
    } ).draw();
...
function refresh()
{
  ...
  window.location.href ="{{ url("/logintracker") }}/"+arr[0]+"/"+arr[1];
