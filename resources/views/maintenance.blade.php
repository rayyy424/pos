      ...
      <script type="text/javascript" language="javascript" class="init">
         ...
         $(document).ready(function() {
           ...
           listtable = $('#list').dataTable( {
                   ...
                   columns: [
                     {data: null, title:"No"},
                     {data:"maintenance_service.Id", title:"Id"},
                     {data:"maintenance_service.service", title:"Service"},
                     {data:"maintenance_service.type", title:"Type"},
                     {data:"maintenance_service.start_date", title:"Start Date"},
                     {data:"maintenance_service.end_date", title:"End Date"},
                     {data:"pic.Name", title:"Person-in-Charge"},
                     {data:"users.creator", title:"Creator"},
                     {data:"maintenance_service.created_at", title:"Created_at"},
                     {data:"maintenance_service.next_service_date", title:"Next Service Date"},
                     { data: "photo", title: 'Files',
                      "render": function ( data, type, full, meta ) {
                        var files = getRowFiles(full.maintenance_service.Id);
                        ...
                        return '<button class="upload btn btn-default btn-xs" title="Upload" style="width:unset" id="'+full.maintenance_service.Id+'"><i class="fa fa-upload"></i></button>';
                      }
                    }
                   ],
                   autoFill: {
            ...
            <div class="modal-body">
              <form id="create_form">
                    <div class="form-group">
                      ...
                      <input type="text" name="next_service_date" class="form-control datepicker">
                    </div>
              </form>
            </div>
