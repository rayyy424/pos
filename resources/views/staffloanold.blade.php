      ...
      <script type="text/javascript" language="javascript" class="init">
          ...
          $(document).ready(function() {
            ...
            editor = new $.fn.dataTable.Editor( {
                    ajax: {
                       "url": "{{ asset('/Include/staffloanold.php') }}"
                     },
                    table: "#loantable",
                    idSrc: "staffloan.Id",
                    formOptions: {
                    ...
                    fields: [
                      {
                             ...
                             ipOpts: [
                                 ...
                                 @endforeach
                                     ...
                                     label: "Reason:",
                                     name: "staffloan.Reason",
                                     type:"textarea"
                      },{
                                  label: "Amount:",
                                  name: "staffloan.Amount",
                                  attr: {
                                     type: "number"
                                   }
                                 ...
                                 label: "Repayment_Start_On:",
                                 name: "staffloan.Repayment_Start_On",
                                 type:   'datetime',
                                 format: 'DD-MMM-YYYY',
                                  attr: {
                                    autocomplete: "off"
                               ...
                               loantable=$('#loantable').dataTable( {
                                 ajax: {
                                    "url": "{{ asset('/Include/staffloanold.php') }}"
                                       ...
                                       columnDefs: [{ "visible": false, "targets": [2,10] },{"className": "dt-center", "targets": "_all"}],
                                       responsive: false,
                                       sScrollX: "100%",
                                       bAutoWidth: true,
                                       sScrollY: "100%",
                                       ...
                                       fnInitComplete: function(oSettings, json) {
                                         ...
                                         for (var i = 0; i < rows.length; i++) {
                                             total_amount=total_amount+parseFloat(rows[i].staffloan.Amount);
                                       ...
                                       columns: [
                                                {  data: null, "render":"", title:"No"},
                                                {
                                                   ...
                                                   "render": function ( data, type, full, meta ) {
                                                       @if ($me->Edit_User)
                                                          return '<a href="staffloan-old/'+full.staffloan.Id+'" alt="View" title="View"><i class="fa fa-eye fa-2x"></i> </a>';
                                                       @else
                                                          return '-';
                                                       @endif
                                              ...
                                              { data: "staffloan.Amount", title:"Amount"},
                                              ...
                                              "render": function ( data, type, full, meta ) {
                                                     ...
                                                     if (full.paid_month.Total) {
                                                       return (parseFloat(full.staffloan.Amount)-parseFloat(full.paid_month.Total)).toFixed(2);

                                                     } else {
                                                       return (parseFloat(full.staffloan.Amount)).toFixed(2);
                                                     }

                                              }},
                                              { data: "staffloan.created_at", title: "Created At"},
                                              { data: "staffloan.updated_at", title: "Updated At"}
