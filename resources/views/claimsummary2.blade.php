       ...
       <script type="text/javascript" language="javascript" class="init">
          ...
          $(document).ready(function() {
            ...
            all = $('#all').dataTable( {
                ...
                adminfinance = $('#adminfinancetable').dataTable( {
                    ...
                    engineering = $('#engineeringtable').dataTable( {
                               ...
                               { data: "projects.Project_Name"},
                                ...
                                { data: "Total_Claim_With_Allowance_Monetary",
                                   ...
                                   "render": function ( data, type, full, meta ) {
                                     ...
                                     if(full.Staff_Monetary_Comp=="")
                                     {
                                      ...
                                      return (parseFloat(full.Total_Claim_Without_SmartPay.replace(",",""))+parseFloat(full.Staff_Allowance.replace(",",""))+parseFloat(full.Staff_Monetary_Comp.replace(",",""))).toLocaleString('en-US', {minimumFractionDigits: 2});
                                ...
                                { data: "Total_Payable",
                                   ...
                                   "render": function ( data, type, full, meta ) {
                                       ...
                                       return (parseFloat(full.Total_Claim_Without_SmartPay.replace(",",""))+parseFloat(full.Staff_Allowance.replace(",",""))+parseFloat(full.Staff_Monetary_Comp.replace(",",""))-parseFloat(full.Total_Advance.replace(",",""))-parseFloat(full.Total_Summon.replace(",",""))).toLocaleString('en-US', {minimumFractionDigits: 2});
                                 ...
                                 columns: [
                                   ...
                                   { data: "users.Name",
                                     "render": function ( data, type, full, meta ) {
                                      ...
                                      return '<a href="{{ url('/') }}/userclaimbreakdown2/'+full.users.Id+'/{{$month}}/{{$year}}" target="_blank">'+data+'</a>';
                                      },
                                      title: "Name"},
...
@section('content')
    ...
    <section class="content">
      ...
      <div class="modal fade" id="chartpopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h4 class="modal-title" id="myModalLabel">Total Claim Expenses Type</h4>
                </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Total Claim Summary</h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table id="adminfinancetable" class="display" cellspacing="0" width="100%" padding="30px" style="font-size: 13px;">
                  <thead>
                      {{-- prepare header search textbox --}}
                      <tr>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table id="engineeringtable" class="display" cellspacing="0" width="100%" padding="30px" style="font-size: 13px;">
                  <thead>
                      {{-- prepare header search textbox --}}
                      <tr>
  ...
  <script>
    ...
    function refresh()
    {
      ...
      window.location.href ="{{ url("/claimsummary2") }}/"+month+"/"+year;
