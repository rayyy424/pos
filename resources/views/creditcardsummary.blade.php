...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Credit Card Summary</li>
      </ol>
    </section>
      ...
      <div class="row>">
        ...
        <div class="col-md-2">
          <select class="form-control" id="owner">
            <option></option>
              <option <?php if($owner == "ALVIN") echo ' selected="selected" '; ?>>ALVIN</option>
              <option <?php if($owner == "ADELINE") echo ' selected="selected" '; ?>>ADELINE</option>
          </select>
        </div>
        ...
        <div class="col-md-2">
          <select class="form-control" id="type">
            <option></option>
            @foreach($types as $num)

              <option <?php if($num == $type) echo ' selected="selected" '; ?>>{{$num}}</option>
                            ...
                            <div class="col-md-8">
                              <div class="box box-primary">
                                <div class="box-header with-border">
                                  <h4 class="box-title">Credit Card {{$owner}} {{$type}}</h4>
...
function refresh() {
    ...
    if(owner=="")
    {
      ...
      window.location.href ="{{ url("/creditcardsummary") }}/"+year;
    }
    else if(type=="")
    {

      window.location.href ="{{ url("/creditcardsummary") }}/"+year+"/"+owner;
    }
    else {

      window.location.href ="{{ url("/creditcardsummary") }}/"+year+"/"+owner+"/"+type;
    }
