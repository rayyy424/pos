...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Requestor KPI<small>Delivery Management</small></h1>

		<ol class="breadcrumb">
			<li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="#">Delivery Management</a></li>
			<li class="active">Requestor KPI</li>
		</ol>
	</section>
		            	...
		            	<div class="row">
                            ...
                            <div class="col-md-4">
                                <select id="requestor" name="requestor" class="form-control select2">
                                    <option value="" selected="">Select Requestor Name</option>
                                    @foreach($requestor as $r)
                                    ...
                                    @foreach($recalltime as $recall)
                                      <tr>
                                        <td>{{$i}}</td>
                                          ...
                                          @endforeach
                                          @if($recall->RequestorId == $req->RequestorId)
                                            <td>
                                             {{$recall->recallcount}}
                                            </td>
                                          @else
