...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="active">Utility Summary</li>
      </ol>
    </section>
        ...
        <div class="col-md-2">
          <select class="form-control" id="type">
            ...
            @foreach($category as $category1)
              ...
              <option <?php if($category1->Option == $type) echo ' selected="selected" '; ?>>{{$category1->Option}}</option>
        ...
        <div class="col-md-2">
          <select class="form-control" id="branch">
            ...
            @foreach($branches as $bran)
              ...
              <option <?php if($bran->Branch == $branch) echo ' selected="selected" '; ?>>{{$bran->Branch}}</option>
                            ...
                            <div class="col-md-8">
                              <div class="box box-primary">
                                <div class="box-header with-border">
                                  <h4 class="box-title">Utility Summary {{$type}} Paid Amount</h4>
...
function refresh() {
    ...
    window.location.href ="{{ url("/utilitysummary") }}/"+year+"/"+type+"/"+branch;
}
