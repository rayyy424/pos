...
$(function(){
    ...
    $('#saveBtn').click(function(){
        ...
        var message="The driver and company is required.";
...
function updateStatus(id,status,type)
{
    ...
    if(!err){
        ...
        console.log($('#extraincentive').val())
        $.ajax({
            url:"{{ url('/changeDeliveryStatus')}}",
            method:"post",
            data:{
                "id":id,
                'vehicle':{{$detail->roadtax}},
                'incentive':$('#extraincentive').val(),
                "status":status,
                "type":type,
