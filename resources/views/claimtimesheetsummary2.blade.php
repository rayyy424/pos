...
@section('content')
      ...
      <div class="row">
        ...
        <div class="box box-success">
         ...
         <div class="col-sm-1">
          ...
          {{-- <div class="col-md-6">
            <div class="input-group">
              <button type="button" class="btn btn-success btn" data-toggle="modal" onclick="notifyunprocessed();">Notify Unprocessed</button>
            </div>
          </div> --}}
                       ...
                       <tr id="row_{{ $i }}" >
                           @foreach($timesheet as $key=>$value)
                            ...
                            @elseif($key=="Claim Submitted" && $value=="Yes")
                                 <td>
                                   <a href="{{ url("/claim") }}/{{$timesheet->ClaimsheetId}}/{{$timesheet->Id}}/null/{{$start}}/{{$end}}" target="_blank">{{$value}}</a>
                                 </td>
  ...
  <script>
    ...
    function refresh()
    {
      ...
      window.location.href ="{{ url("/claimtimesheetsummary2") }}/"+month+"/"+year;

    }

    function notifyunprocessed()
    {
      ...
      $.ajax({
                  ...
                  success: function(response){
                    ...
                    if (response==1)
                    {
                      ...
                      var errormessage="Failed to notify!";
