                   ...
                   reviewtable=$('#reviewtable').dataTable( {
                          ...
                          //  },
                           ...
                           columns: [
                                   ...
                                   { data: "reviews.Reviewed_Date",title: "Reviewed_Date" },
                                   { data: "files.Web_Path",
                                     render: function ( url, type, row ) {
                                          if (url)
                                          {
...
@section('content')
             ...
             <div class="tab-content">
               <div class="active tab-pane" id="personaldetail">
                   <div class="box-body">
                      ...
                      <div class="box-body">
                        <!-- <button type="button" class="btn btn-danger btn-small" data-toggle="modal" data-target="#UpdateProfile">Update Profile</button> -->
                        <!-- <button type="button" class="btn btn-danger btn-small" data-toggle="modal" data-target="#UpdateProfilePicture">Update Profile Picture</button> -->
                        <button type="button" class="btn btn-danger btn-small" data-toggle="modal" data-target="#ChangePassword"><i class="fa fa-key" aria-hidden="true"></i> Change Password</button>
                        <!-- <a href="{{ url('/export1') }}/{{$UserId}}" target="_blank"><button type="button" class="btn btn-danger btn-small" ><i class="fa fa-download" aria-hidden="true"></i> Export CV</button></a> -->
                        <!-- <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#ExportPDF">Export CV</button> -->

                      @if( $user->Status=="Pending Account Detail Approval")
                        <button type="button" class="btn btn-danger btn-small" data-toggle="modal" data-target="#ApproveProfile">Approve Profile Update</button>
                        <button type="button" class="btn btn-danger btn-small" data-toggle="modal" data-target="#RejectProfile">Reject Profile Update</button>
                      @endif
                      </div>
                      ...
                      <div class="modal fade" id="ApproveProfile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h4 class="modal-title" id="myModalLabel">Approve Profile</h4>
                            </div>
                            <div class="modal-body">
                                Are you sure you wish to approve this profile update?
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              <button type="button" class="btn btn-primary" onclick="approveprofile()">Approve</button>
                            </div>
                          </div>
                        </div>
                      </div>

                      <div class="modal fade" id="RejectProfile" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h4 class="modal-title" id="myModalLabel">Reject Profile</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                  <label>Comment</label>
                                  <textarea class="form-control" rows="3" id="Comment" name="Comment" placeholder="Enter your comment here..."></textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              <button type="button" class="btn btn-danger" onclick="rejectprofile()">Reject</button>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="modal fade" id="ExportPDF" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                         <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <center>
                               <a class="btn btn-primary btn-lg" href="{{ url('/export1') }}/{{$UserId}}" target="_blank">CV 1</a>
                               <a class="btn btn-primary btn-lg" href="{{ url('/export2') }}/{{$UserId}}" target="_blank">CV 2</a>
                               <a class="btn btn-primary btn-lg" href="{{ url('/export3') }}/{{$UserId}}" target="_blank">CV 3</a>
                             </center>
                            </div>
                          </div>
                        </div>
                          ...
                          <br>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-3">
                                ...
                                <button type="button" class="btn btn-danger btn-small" data-toggle="modal" data-target="#UpdateProfile" style="float:right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update Profile</button>
                              </div>
                                ...
                                <br><br>
                                  ...
                                  <div class="col-lg-6" style="padding:0;">
                                    ...
                                    <div class="col-lg-6">
                                    <img class="profile-user-img img-responsive" src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=StaffId:{{$user->Staff_ID}}" title="Link to Google.com" />
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                      <input type="text" class="form-control" id="StaffId" name="StaffId" value="{{$user->Staff_ID}}">
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Position'))
                                        <select class="changed form-control select" id="Position" name="Position" style="width: 100%;">
                                      @else
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Grade'))
                                        <select class="changed form-control select" id="Grade" name="Grade" style="width: 100%;">
                                      @else
                                        <select class="form-control select2" id="Grade" name="Grade" style="width: 100%;">
                                      @endif
                                        ...
                                        @foreach ($options as $key => $option)
                                          @if ($option->Field=="Grade")
                                            ...
                                            <option <?php if($user->Grade == $option->Option) echo ' selected="selected" '; ?>>{{$option->Option}}</option>
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Company'))
                                        <select class="changed form-control select" id="Company" name="Company" style="width: 100%;">
                                      @else
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Entitled_for_OT'))
                                        <select class="changed form-control select" id="Entitled_for_OT" name="Entitled_for_OT" style="width: 100%;">
                                      @else
                                        <select class="form-control select2" id="Entitled_for_OT" name="Entitled_for_OT" style="width: 100%;">
                                      @endif

                                        <option></option>
                                              <option <?php if($user->Entitled_for_OT == "Yes") echo ' selected="selected" '; ?>>Yes</option>
                                              <option <?php if($user->Entitled_for_OT == "No") echo ' selected="selected" '; ?>>No</option>
                                    ...
                                    <div class="col-lg-6">
                                      <label>Holiday Territory : </label>
                                    </div>

                                    <div class="col-lg-6">

                                      <select class="form-control select2" id="HolidayTerritoryId" name="HolidayTerritoryId" style="width: 100%;">
                                        <option></option>
                                        @foreach($holidayterritories as $ht)
                                          <option value="{{ $ht->Id }}" {{ $ht->Id == $user->HolidayTerritoryId ? 'selected' : '' }}>{{ $ht->Name }}</option>
                                        @endforeach
                                      </select>
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Working_Days'))
                                        <select class="changed form-control select" id="Working_Days" name="Working_Days" style="width: 100%;">
                                      @else
                                        <select class="form-control select2" id="Working_Days" name="Working_Days" style="width: 100%;">
                                      @endif


                                        <option <?php if($user->Working_Days == 5.0) echo ' selected="selected" '; ?>>5.0</option>
                                        <option <?php if($user->Working_Days == 5.5) echo ' selected="selected" '; ?>>5.5</option>
                                        <option <?php if($user->Working_Days == 6.0) echo ' selected="selected" '; ?>>6</option>
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Joining_Date'))
                                        <input type="text" class="changed form-control" id="Joining_Date" name="Joining_Date" value="{{$user->Joining_Date}}">
                                      @else
                                        <input type="text" class="form-control" id="Joining_Date" name="Joining_Date" value="{{$user->Joining_Date}}">
                                      @endif
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Confirmation_Date'))
                                        <input type="text" class="changed form-control" id="Confirmation_Date" name="Confirmation_Date" value="{{$user->Confirmation_Date}}">
                                      @else
                                        <input type="text" class="form-control" id="Confirmation_Date" name="Confirmation_Date" value="{{$user->Confirmation_Date}}">
                                      @endif
                                    ...
                                    <div class="col-lg-6">
                                      @if(str_contains($changes, 'Resignation_Date'))
                                        <input type="text" class="changed form-control" id="Resignation_Date" name="Resignation_Date" value="{{$user->Resignation_Date}}">
                                      @else
                                        <input type="text" class="form-control" id="Resignation_Date" name="Resignation_Date" value="{{$user->Resignation_Date}}">
                                      @endif
                ...
                <div class="tab-pane" id="Export">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <form enctype="multipart/form-data" id="upload_form_detail" role="form" method="POST" action="{{ url('/userdetailpdf') }}/{{$user->Id}}" target="_blank">
                        ...
                        <br>
                              ...
                              <br><br>
                                ...
                                <div class="col-lg-6" style="padding:0;">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      <select class="form-control select2" id="Grade1" name="Grade1" style="width: 100%;">
                                  ...
                                  <div class="col-lg-6">
                                      ...
                                      <select class="form-control select2" id="Company1" name="Company1" style="width: 100%;">
                                  ...
                                  <div class="col-lg-6">
                                      <select class="form-control select2" id="Entitled_for_OT1" name="Entitled_for_OT1" style="width: 100%;">
                                      <option></option>
                                      <option <?php if($user->Entitled_for_OT == "Yes") echo ' selected="selected" '; ?>>Yes</option>
                                      <option <?php if($user->Entitled_for_OT == "No") echo ' selected="selected" '; ?>>No</option>
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <select class="form-control select2" id="HolidayTerritoryId1" name="HolidayTerritoryId1" style="width: 100%;">
                                      <option></option>
                                      @foreach($holidayterritories as $ht)
                                        <option value="{{ $ht->Name }}" {{ $ht->Id == $user->HolidayTerritoryId ? 'selected' : '' }}>{{ $ht->Name }}</option>
                                      @endforeach
                                    </select>
                                  ...
                                  <div class="col-lg-6">
                                      <select class="form-control select2" id="Working_Days1" name="Working_Days1" style="width: 100%;">
                                      <option <?php if($user->Working_Days == 5.0) echo ' selected="selected" '; ?>>5.0</option>
                                      <option <?php if($user->Working_Days == 5.5) echo ' selected="selected" '; ?>>5.5</option>
                                      <option <?php if($user->Working_Days == 6.0) echo ' selected="selected" '; ?>>6</option>
                                    </select>
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="Confirmation_Date1" name="Confirmation_Date1" value="{{$user->Confirmation_Date}}">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="Resignation_Date1" name="Resignation_Date1" value="{{$user->Resignation_Date}}">
                                    </div>
                                  </font>
                          ...
                          <div class="row1" style="height: 40px;">
                            <input type="submit" class="btn btn-danger" style="float:right;" value="Print"></input>
                          </div>
  ...
  function approveprofile() {
      ...
      $.ajax({
                  url: "{{ url('/user/approveprofile') }}",
                  method: "POST",
                  data: {
                    UserId:userid,Company_Email:companyemail,Personal_Email:personalemail
                  },

                  success: function(response){
                    if (response==0)
                    {
                      var message ="Failed to approve profile detail!";
  ...
  function rejectprofile() {
      ...
      $.ajax({
                  url: "{{ url('/user/rejectprofile') }}",
                  method: "POST",
                  data: {
                    UserId:userid,Company_Email:companyemail,Personal_Email:personalemail,Comment:comment
                  },

                  success: function(response){
                    if (response==0)
                    {
                      var message ="Failed to reject profile detail!";

                      $("#warning-alert ul").html(message);
                      $("#warning-alert").show();

                      $('#RejectProfile').modal('hide')
