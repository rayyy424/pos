      ...
      var timesheeteditor;
            ...
            $(document).ready(function() {
                          ...
                          timesheeteditor = new $.fn.dataTable.Editor( {
                                  ajax: {
                                     "url": "{{ asset('/Include/otmanagementhod.php') }}",
                                     "data": {
                                         "Start": "{{ $start }}",
                                         "End": "{{ $end }}",
                                  ...
                                  fields: [
                                          ...
                                          {
                                                 label: "Verified_OT:",
                                                 name: "timesheets.OT_HOD_Verified",
                                                 type:   'select',
                                                 options: [
                                                   { label :"", value: ""},
                                                   { label :"No", value: "0"},
                       ...
                       $('#engineertable').on( 'click', 'tbody td:not(.child), tbody span.dtr-data', function (e) {
                            ...
                            if (dtCols[colIndex].data == 'timesheets.OT_Verified') {
                              console.log(currentRow.OT_HOD_Verified);
                              if (currentRow.OT_HOD_Verified){
...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">HOD OT Management</li>
      </ol>
    </section>
  ...
  $(function () {
    ...
    endDate: '{{$end}}'});
      ...
      function refresh()
      {
        ...
        window.location.href ="{{ url("/otmanagementhod") }}/"+arr[0]+"/"+arr[1]+"/"+includeresigned;
