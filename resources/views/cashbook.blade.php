          ...
          summary = $('#summary').dataTable( {
                  ...
                  columns: [
                    ...
                    { data: "DocNo",title:"DocNo"},
              			...
              			{ data: "DocType",title:"DocType"},
              			{ data: "DealWith",title:"DealWith"},
              			{ data: "Description",title:"Description"},
              			{ data: "CurrencyCode",title:"CurrencyCode"},
              			...
              			{ data: "FurtherDescription",title:"FurtherDescription"},
              			{ data: "SalesAgent",title:"SalesAgent"},
              			{ data: "Amount",title:"Amount"},
              			{ data: "TaxableAmt",title:"TaxableAmt"},
              			{ data: "RCHQAmount",title:"RCHQAmount"},
              			{ data: "PaymentMethod",title:"PaymentMethod"},
              			{ data: "ChequeNo",title:"ChequeNo"},
              			{ data: "PaymentAmt",title:"PaymentAmt"},
              			{ data: "BankCharge",title:"BankCharge"},
              			{ data: "ToBankRate",title:"ToBankRate"},
              			{ data: "PaymentBy",title:"PaymentBy"},
              			{ data: "FloatDay",title:"FloatDay"},
              			{ data: "IsRCHQ",title:"IsRCHQ"},
              			{ data: "RCHQDate",title:"RCHQDate"}
                  ],
                 buttons: [
                         {
                                 extend: 'collection',
...
<script>
    ...
    function refresh()
    {
       ...
       if(company)
       {
        window.location.href ="{{ url("/cashbook") }}/"+start+"/"+end+"/"+company;
       }
       else {
         window.location.href ="{{ url("/cashbook") }}/"+start+"/"+end;
       }
