    ...
    $(document).ready(function() {
		...
		oTable=$('#historytable').dataTable( {
			...
			columns: [
				...
				{ data:"gensetinventory_history.activity", title:'Activity'},
				{ data:"gensetinventory_history.branch", title:'Branch'},
				{ data:"gensetinventory_history.qty", title:'Quantity'},
				{ data:"users.Name", title:'Executed By'},
				{ data:"gensetinventory_history.created_at", title:'Created At'},
			],
			autoFill: {
				editor:  editor,
			},
