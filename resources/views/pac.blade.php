...
@section('content')
    ...
    <form enctype="multipart/form-data" id="upload_form" role="form" method="POST" action="{{ url('/pacpdf/') }}" >
      ...
      <div class="CompanyName">
          ...
          <h4 style="color:#323277;">ACCEPTANCE CERTIFICATE</h4>
      ...
      <div class="row1" >
        ...
        <img width="80" src="{{ asset('/img/Picture1.png') }}" />Huawei Technologies (Malaysia) Sdn. Bhd.
        <br>
        <table class="main">
            <tr>
                <td style="width:20%">Supplier Code:  </td>
                <td style="width:25%">
                  <input type="text" name="SupplierCode" class="form-control" value="Z001MU" id="">
                </td>
                <td tyle="width:23%;margin-left:10px">Supplier Name:</td>
                <td tyle="width:25%">
                  <input type="text" name="SupplierName" class="form-control" value="JALUR MILENIUM SDN BHD" id="">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                  <input type="text" name="SubContractNo" class="form-control" value="{{$podetail->Sub_Contractor_No}}" id="">
                </td>
            </tr>
            ...
            <tr>
                <td>EngineeringNo:</td>
                <td>
                  <input type="text" name="EngineeringNo" class="form-control" value="{{$podetail->Engineering_No}}" id="">
                </td>
                <td>Central Site :</td>
                <td>
                  <input type="text" name="CentralSite" class="form-control" value="" id="">
                </td>
            </tr>
            ...
            <tr>
                <td>PO No. :</td>
                <td>
                  <input type="text" name="PONo" class="form-control" value="{{$podetail->PO_No}}" id="">
                </td>
            </tr>
      ...
      <input type="submit" class="btn btn-primary" style="float:right;" value="Print PDF"></input>
