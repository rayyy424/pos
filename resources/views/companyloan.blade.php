      ...
      <script type="text/javascript" language="javascript" class="init">
          ...
          $(document).ready(function() {
            ...
            editor = new $.fn.dataTable.Editor( {
                    ajax: {
                       "url": "{{ asset('/Include/companyloan.php') }}"
                     },
                    table: "#loantable",
                    idSrc: "companyloans.Id",
                    formOptions: {
                         bubble: {
                             submit: 'allIfChanged'
                         }
                    ...
                    fields: [
                      {
                             ...
                             ipOpts: [
                                 ...
                                 @endforeach
                                     ...
                                     label: "Purpose:",
                                     name: "companyloans.Purpose",
                                     type:"textarea"
                      },{
                                     label: "Bank Account No:",
                                     name: "companyloans.Bank_Account_No",
                                     type:"select2",
                                     ipOpts: [
                                          @foreach($companies as $company)
                                          { label :"{{$company->bank_acct}}", value: "{{$company->bank_acct}}" },
                                          @endforeach
                                     ]
                      },{
                                  label: "Date:",
                                  name: "companyloans.Date",
                                  type:   'datetime',
                                  format: 'DD-MMM-YYYY',
                                  attr: {
                                    autocomplete: "off"
                                  ...
                                  label: "Date_Approved:",
                                  name: "companyloanstatuses.update_at",
                                  type:   'hidden',
                                  format: 'DD-MMM-YYYY',
                                  attr: {
                                    autocomplete: "off"
                                  ...
                                  name: "companyloans.Total_Requested",
                                  attr: {
                                     type: "number"
                                   }
                                  ...
                                  name: "companyloans.Total_Approved",
                                  type: "hidden",
                                  attr: {
                                     type: "number"
                                   }
                                 ...
                                 label: "Approver:",
                                 name: "companyloans.Approver",
                                 type:"hidden"

                     },{
                                  label: "created_at:",
                                  name: "companyloans.created_at",
                                  type: "hidden",
                                 ...
                                 ajax: {
                                    ...
                                    data:{
                                       ...
                                       fnInitComplete: function(oSettings, json) {
                                        ...
                                        // console.log(rows[i].paid_month.Total);
                                         for (var i = 0; i < rows.length; i++) {
                                             if (! isNaN(rows[i].companyloans.Total_Approved) && rows[i].companyloans.Total_Approved) {
                                                each_amount = parseFloat(rows[i].companyloans.Total_Approved);
                                       ...
                                       columns: [
                                                {  data: null, "render":"", title:"No"},
                                                {
                                                   ...
                                                   "render": function ( data, type, full, meta ) {
                                                       @if ($me->Edit_User)
                                                          return '<a href="companyloans/'+full.companyloans.Id+'" alt="View" title="View"><i class="fa fa-eye fa-2x"></i> </a>';
                                                       @else
                                                          return '-';
                                                       @endif
                                              ...
                                              { data: "company.Register_Num" , title:"Register Number"},
                                              {data:'company.Company_Name', editField: "companyloans.CompanyId",title:"Name"},
                                              { data: "company.Branch", title:"Branch"},
                                              { data: "companyloans.Purpose", title:"Purpose"},
                                              { data: "companyloans.Date", title:"Date"},
                                              { data: "companyloanstatuses.update_at", title:"Date_Approved"},
                                              { data: "companyloans.Total_Requested", title:"Total Requested"},
                                              { data: "companyloans.Total_Approved", title:"Total Approved"},
                                              { data: "paid_month.Total", title:"Total_Paid"},
                                              { title: "Outstanding Balance", title:"Outstanding Balance",
                                              "render": function ( data, type, full, meta ) {

                                                     if (full.paid_month.Total) {
                                                       return (parseFloat(full.companyloans.Total_Approved)-parseFloat(full.paid_month.Total)).toFixed(2);

                                                     } else {
                                                       return (parseFloat(full.companyloans.Total_Approved)).toFixed(2);
                                                     }

                                              }},
                                              {data:'us.Name', editField: "companyloans.Approver",title:"Approver"},
                                              ...
                                              // }},
                                              { data: "companyloans.created_at", title: "Created At"},
                                              { data: "companyloans.updated_at", title: "Updated At"}
...
@section('content')
    ...
    <section class="content-header">
      <h1>
        Company Loan
        <small>Speed Freak Management</small>
      </h1>
      <ol class="breadcrumb">
...
function refresh()
{
  ...
  window.location.href ="{{ url("/companyloan")}}/"+arr[0];
