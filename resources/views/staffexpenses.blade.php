                                       ...
                                       columns: [
                                                {  data: null, "render":"", title:"No"},
                                                {
                                                   ...
                                                   "render": function ( data, type, full, meta ) {
                                                       @if ($me->Edit_User)
                                                          return '<a href="{{url('staffexpensesrecord')}}/'+full.users.Id+'" alt="View" title="View"><i class="fa fa-eye fa-2x"></i> </a>';
                                                       @else
                                                          return '-';
                                                       @endif
...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Staff Expenses</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
       <div class="col-md-2">
         ...
         <h4><b>Total </b> : <p class="pull-right"><i><span id='total'>RM{{$total ? $total : 0}}</span></i></p></h4>
...
<script>
  ...
  function refresh()
  {
    ...
    window.location.href ="{{ url("/staffexpenses") }}/"+year;
...
function refresh()
{
  ...
  window.location.href ="{{ url("/staffexpenses") }}/"+arr[0]+"/"+arr[1];
