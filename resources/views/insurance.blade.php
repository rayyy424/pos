      ...
      <script type="text/javascript" language="javascript" class="init">
         ...
         $(document).ready(function() {
           ...
           listtable = $('#list').dataTable( {
                   ...
                   columns: [
                     {data: null, title:"No"},
                     {data:"insurance.Id", title:"Id"},
                     {data:"insurance.description", title:"Description"},
                     {data:"insurance.start_date", title:"Start Date"},
                     {data:"insurance.end_date", title:"End Date"},
                     {data:"insurance.amount", title:"Amount(RM)"},
                     {data:"insurance.type", title:"Type"},
                     {data:"button", title:"Action",
                        "render": function ( data, type, full, meta ) {
                           var files = getRowFiles(full.insurance.Id);
                          ...
                          return '<button class="upload btn btn-default btn-xs" title="Upload" style="width:unset" id="'+full.insurance.Id+'"><i class="fa fa-upload"></i></button>';        
                        }
                      }
                   ],
                   autoFill: {
            ...
            <div class="box-header with-border">
              ...
              <br><br>
                  <table id="list" class="list" cellspacing="0" width="100%" padding="30px" style="font-size: 13px;">
                            ...
                            <tbody>
                              <?php $i = 0; ?>
                              @foreach($insurance as $maintenances)
