                                       ...
                                       columns: [
                                                {  data: null, "render":"", title:"No"},
                                                {
                                                   ...
                                                   "render": function ( data, type, full, meta ) {
                                                       @if ($me->Edit_User)
                                                          return '<a href="{{ URL::to('/')}}/user/'+full.users.Id+'" alt="Edit" title="Edit"><i class="fa fa-pencil-square-o fa-2x"></i> </a> <a href="{{ URL::to('/')}}/user/'+full.users.Id+'/Export/" alt="View" title="View"><i class="fa fa-eye fa-2x" ></i></a>';
                                                       @else
                                                          return '-';
                                                       @endif
                                              ...
                                              { data: "users.User_Type" },
                                               ...
                                               { data: "users.Permanent_Address"},//25
                                       ...
                                       buttons: [
                                         { extend: "remove", editor: editor },
                                         {
                                           ...
                                           action: function ( e, dt, node, config ) {
                                               ...
                                               window.location.href = "{{url('/user/resigned')}}";
                                           },
                                         },
                                         {
                                             extend: 'excelHtml5',
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Resigned Staff</li>
      </ol>
    </section>
