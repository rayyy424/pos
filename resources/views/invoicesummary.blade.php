...
@section('datatable-js')
      ...
      var table2 = $('#table2').dataTable( {
          ...
          // column:[
          //   {data: null, "render":"", title:"No"},
          //   {data: "Invoice_Type", title: "Invoice_Type"},
          //   {data: "#_of_Invoice", title: "#_of_Invoice"},
          //   {data: "Total_Amount", title: "Total_Amount"}
          // ],
          select: {
                  style:    'os',
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h5 class="box-title"><b>Job Done Pending Invoice<b></h5>
     ...
     <div class="row">
       ...
       <div class="col-md-12">
         ...
         <h5 class="box-title"><b>Invoice Pending Payment [By Invoice Type]<b></h5>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <h5 class="box-title"><b>Invoice Pending Payment [By Company]<b></h5>
...
function refresh()
{
  ...
  window.location.href ="{{ url("/InvoiceSummary") }}/"+arr[0]+"/"+arr[1];
