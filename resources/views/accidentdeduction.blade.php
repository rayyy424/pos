             ...
             // } );
               ...
               deductiontable = $('#deductiontable').dataTable( {
                     ...
                     ajax: {
                      ...
                      sScrollX: "100%",
                      aaSorting:[[1,'desc']],
                      columnDefs: [{ "visible": false, "targets": [1,2] },{"className": "dt-left", "targets": []},{"className": "dt-center", "targets": "_all"}],
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li class="active">Accident Deduction</li>
      </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    ...
                    @if($deductions->MD==$me->UserId)
                      <a class="btn btn-danger btn-small" onclick="submitapproval('GENSET')" style="float:right">Final Approval</a>
                    @endif
                </div>
                <div class="col-md-12">
                  <br>
                  ...
                  <table id="deductiontable" class="display" cellspacing="0" width="100%" padding="30px" style="font-size: 13px;">
                      <thead>
                          ...
                          <tr>
                            @foreach($accidentdeduction as $key=>$value)
                      ...
                      <tbody>
                        ...
                        <?php $i = 0; ?>
                        @foreach($accidentdeduction as $accidentdeduction1)

                          <tr id="row_{{ $i }}">
                              <td></td>
                              @foreach($accidentdeduction1 as $key=>$value)
                                <td>
                                  {{ $value }}
                                </td>
                              @endforeach
